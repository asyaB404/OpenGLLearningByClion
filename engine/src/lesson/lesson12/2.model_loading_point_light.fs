...
// 材质属性（使用纹理贴图）
// 注意：纹理命名约定为 texture_diffuseN, texture_specularN 等
// 其中 N 是从 1 开始的数字
// 注意：sampler2D 不能放在 struct 中，需要作为独立的 uniform
uniform sampler2D texture_diffuse1;     // 漫反射贴图 1
uniform sampler2D texture_specular1;    // 镜面反射贴图 1
