// ============================================================================
// Lesson 12.3: 模型加载 + 平行光（Model Loading + Directional Light）
// ============================================================================
// 本课程学习内容：
// 1. 在模型加载的基础上添加平行光光照
// 2. 平行光的特点：固定方向，无距离衰减
...
// ============================================================================
// Lesson12_3Application 类 - 继承自 CameraApplication
// ============================================================================
class Lesson12_3Application : public CameraApplication
{
public:
    Lesson12_3Application() 
        : CameraApplication(800, 600, "OpenGL Learning - Lesson 12.3: Model Loading + Directional Light")
    {
    }
...
protected:
    ...
    virtual void OnInitialize() override
    {
        ...
        // 创建着色器程序
        std::string vertexPath = std::string(PROJECT_ROOT) + "/engine/src/lesson/lesson12/3.model_loading_directional_light.vs";
        std::string fragmentPath = std::string(PROJECT_ROOT) + "/engine/src/lesson/lesson12/3.model_loading_directional_light.fs";
    ...
    virtual void OnRender() override
    {
        ...
        // 设置平行光属性
        m_shader->setVec3("light.direction", -0.2f, -1.0f, -0.3f);  // 光源方向
